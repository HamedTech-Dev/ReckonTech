...
function Footer() {
  ...
  return (
    <div className="w-[100vw] h-min flex bg-[var(--dark)] p-10 mobile:flex-col mobile:justify-between mobile:items-center mobile:p-0">
      ...
      <div className="h-full w-1/2 flex flex-col gap-10 items-center mobile:w-full mobile:items-start mobile:pl-[10%] mobile:gap-5 mobile:mt-5 mobile:mb-3 snap-end">
        <span
          className="text-[var(--light)] text-[2.5vw] flex mobile:text-[7vw]"
          role="button"
          onClick={() => {
