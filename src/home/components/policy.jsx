    ...
    >
      ...
      <article className="mobile:flex-col mobile:flex-nowrap mobile:overflow-y-auto flex flex-wrap mobile:px-0 px-20 h-5/6">
        <section className="mb-3 w-1/2 px-5 mobile:p-0 mobile:text-start mobile:w-full mobile:h-max">
          <h3 className="text-[2vw] mobile:text-[7.3vw] text-[var(--dark)] font-semibold mb-3">Quality Assurance Policy</h3>
        ...
        <section className="mb-3 w-1/2 0x-5 mobile:p-0 mobile:text-start mobile:w-full mobile:h-max">
          <h3 className="text-[2vw] mobile:text-[7.3vw] text-[var(--dark)] font-semibold mb-3">Privacy Policy</h3>
          <p  className="text-[var(--light)] text-[1.3vw] mobile:text-[5vw]">
        ...
        <section className="mb-3 w-1/2 0x-5 mobile:p-0 mobile:text-start mobile:w-full mobile:h-max">
          <h3 className="text-[2vw] mobile:text-[7.3vw] text-[var(--dark)] font-semibold mb-3">Data Security Policy</h3>
          <p  className="text-[var(--light)] text-[1.3vw] mobile:text-[5vw]">
        ...
        <section className="mb-3 w-1/2 0x-5 mobile:p-0 mobile:text-start mobile:w-full mobile:h-max">
          <h3 className="text-[2vw] mobile:text-[7.3vw] text-[var(--dark)] font-semibold mb-3">Communication and Transparency Policy</h3>
          <p  className="text-[var(--light)] text-[1.3vw] mobile:text-[5vw]">
